...
from test_LA_VNet_sup16 import test_calculate_metric
from networks.vnet import VNet
from dataloaders import utils
from utils import ramps, losses, metrics
from dataloaders.la_heart_16 import LAHeart, RandomCrop, CenterCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler
...
parser.add_argument('--exp', type=str,
                    default='LA/VNet_sup16_log', help='model_name')
parser.add_argument('--max_iterations', type=int,
                    default=1200, help='maximum epoch number to train')
...
if __name__ == "__main__":
    ...
    # unlabeled_idxs = list(range(labelnum, labelnum))
    ...
    writer = SummaryWriter(snapshot_path + '/la_VNet_sup16_log')
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = loss_seg_dice + loss_seg_ce
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
